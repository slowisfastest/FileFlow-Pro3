...
# 这些导入看似未使用，但对 PyInstaller 分析依赖至关重要
# 它们确保 paddleocr、easyocr 及其所有子模块被正确打包
try:
    import paddle
    import paddleocr
    import paddleocr.ppocr
    import paddleocr.ppocr.utils
    import paddleocr.ppocr.data
    import paddleocr.ppocr.modeling
    import paddleocr.ppocr.losses
    import paddleocr.ppocr.metrics
    import paddleocr.ppocr.optimizer
    import paddleocr.ppocr.scheduler
    import paddleocr.tools
    import paddleocr.tools.infer
    import paddleocr.tools.infer.utility
    import paddleocr.tools.infer.predict_system
    import paddleocr.tools.infer.predict_rec
    import paddleocr.tools.infer.predict_det
    import paddleocr.tools.infer.predict_cls
except ImportError:
    pass  # 打包时可能未安装，但不影响运行时检测
